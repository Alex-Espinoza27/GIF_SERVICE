...
public class Entrepreneurship {
    ...
    public Entrepreneurship(Long id, String nameEntrepreneurship, String rucEntrepreneurship, String locationEntrepreneurship, String phoneEntrepreneurship, User user) {
        this.id = id;
